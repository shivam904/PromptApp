...
const Form = ({type,setPost,post,submitting,handleSubmit}) => {
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md ">{type} and share prompts with the world, and let your imagination run wild with any AI-powered platform.</p>
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        ...
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">Tags {` `}<span className="font-normal">(#product, #web-Development, #Technology)</span></span>
